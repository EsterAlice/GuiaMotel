...
public class UsuarioRestController {
	...
	public static final String SECRET = "@ss1n@TuR@";
	...
	public ResponseEntity<Object> criarUsuario(@RequestBody Usuario usuario){
		...
		public ResponseEntity<Usuario> getMotel(@PathVariable("id") Long idUsuario){
	...
	public ResponseEntity<TokenJWT> logar(@RequestBody Usuario usuario){
		//buscar o usuário no banco de dados
			...
			if(usuario != null) {
				...
				//variáve para a data de expiração
